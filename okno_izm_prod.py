...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(482, 536)
        Dialog.setAcceptDrops(False)
        icon = QtGui.QIcon.fromTheme("Продажи")
        ...
        self.splitter_2.setGeometry(QtCore.QRect(50, 420, 380, 101))
    ...
    def load_data_to_combobox(self):
        ...
        for row in rows:
            self.comboBox.addItem(f"{row[0]}: {row[1]}")  # Комбинированное значение Код и Наименование
        ...
        # Добавление данных в QComboBox
        for row in rows:
            self.comboBox_2.addItem(f"{row[0]}: {row[1]}")  # Комбинированное значение ID и ФИО
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Изменить продажу"))
        self.label.setText(_translate("Dialog", "Изменить продажу"))
        self.pushButton.setText(_translate("Dialog", "Сохранить изменения"))
        self.pushButton_2.setText(_translate("Dialog", "Удалить продажу"))
        self.label_8.setText(_translate("Dialog", "Номер продажи"))
        self.label_7.setText(_translate("Dialog", "Сумма продажи"))
        self.label_11.setText(_translate("Dialog", "Дата"))
        self.label_10.setText(_translate("Dialog", "Код товара"))
        self.label_12.setText(_translate("Dialog", "Количество"))
        self.label_9.setText(_translate("Dialog", "ID сотрудника"))
